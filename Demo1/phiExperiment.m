...
disp(data)
while (~strncmp(data,'Finished',8) | Time > 4000) % Until Arduino signals that it is done
    k=k+1;
...
%
save phiExpData.mat Time phiDot
